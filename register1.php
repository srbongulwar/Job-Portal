  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-9 col-lg-6 col-xl-5">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjJDTFz-u26tco0AqQcAwn-cBOjMg1MQJLUg&usqp=CAU"
                    ...
                    <form action="" method="post">
                        ...
                        <div class="textbox_wrap">
                            <div class="input_group">
                                ...
                                <input type="password" name="password" required="required" value=""  class="form-control" placeholder="Password"><br>
                            </div>
                        </div><br><br>
                        ...
                        <div >
                            ...
                            <p class="small fw-bold mt-2 pt-1 mb-0">you already have an account? <a href="login1.php"
...
<?php
  if(isset($_POST['register']))
  {
    ...
    $password=$_POST['password'];
                ...
                if(mysqli_query($conn,"insert into user(name,email,password,roletype)values('$name','$email','$password','2')"))
                {
